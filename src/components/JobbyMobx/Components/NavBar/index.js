...
class NavBar extends Component {
  logoutHandler = () => {
    ...
    this.props.history.replace("/JobbyMobx/login");
  };
  render() {
    return (
        ...
        <div className="jobby-nav-content">
          ...
          <div className="jobby-nav-middle">
            <ul className="jobby-nav-menu">
              <Link to="/JobbyMobx" className="jobby-nav-link">
                <li>Home</li>
              </Link>
              <Link to="/JobbyMobx/Jobs" className="jobby-nav-link">
                <li>Jobs</li>
              </Link>
            </ul>
          </div>
