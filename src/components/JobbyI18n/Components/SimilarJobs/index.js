...
class SimilarJob extends Component {
  render() {
    ...
    return (
      <Link className="jobby-similarJob-link" to={`/JobbyI18n/jobs/${data.id}`}>
        <div className="jobby-similarJob">
          ...
          <h3 className="jobby-similarJob-description-heading">
            {t("description")}
          </h3>
...
export default withTranslation()(SimilarJob);
